...
3. **Conflict-check** against requirements / specs / ADRs / SAD / Architecture Rules / Guidelines / Guardrails / code. If it conflicts, don't apply — produce a conflict finding.
